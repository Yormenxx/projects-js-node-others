...
export function FeaturesSectionDemo() {
    ...
    return (
        <div className="relative z-10 py-10 max-w-7xl max-auto px-10 ">
            <div>
...
const Feature = ({
    ...
    return (
        ...
        >
            {index < 4 && (
                <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-t from-slate-800 rounded-lg   to-transparent pointer-events-none" />
            )}
            {index >= 4 && (
                <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-b from-slate-800 rounded-lg to-transparent pointer-events-none" />
            )}
