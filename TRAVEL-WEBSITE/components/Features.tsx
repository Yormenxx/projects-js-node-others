      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-20 3xl:px-0 relative w-full flex justify-end ">
        ...
        <div className="z-20 flex w-full flex-col lg:w-[60%]">
          <div className="relative">
            <Image src="/camp.svg" alt="camp" width={50} height={50} className="absolute left-[-45px] top-[-28px] w-10 lg:w-[50px]"/>

            <h2 className="font-extrabold capitalize text-2xl ">Our features</h2>
...
const FeatureItem = ({title,icon,desc}:FeatureItem) =>{
  return (
    <li className="flex w-full flex-1 flex-col items-start">
      ...
      <h2 className="mt-5 capitalize font-bold">
        {title}
      </h2> 
      <p className="mt-5 bg-white/80 text-neutral-700 lg:mt-[30px] lg:bg-none">
        {desc}
      </p>
    </li>
  )
